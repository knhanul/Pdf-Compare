...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        <ul>
        <li>줄바꿈(\\n, \\r)을 공백으로 치환</li>
        <li>연속된 공백을 단일 공백으로 통합</li>
        <li>레이아웃 차이로 인한 줄바꿈 무시</li>
        </ul>
    ...
    def compare_texts(self):
        ...
        try:
            ...
            print(f"\n[정규화 후]")
            print(f"왼쪽 (처음 200자): {normalized_left[:200]}...")
            print(f"오른쪽 (처음 200자): {normalized_right[:200]}...")
            ...
            result_html += f"<p><b>정규화 적용:</b> 줄바꿈과 공백 차이 무시</p>"
            ...
            if differences:
                ...
                result_html += "<p><b>💡 줄바꿈과 공백은 무시되었습니다</b></p>"
            else:
                result_html += "<p><b>✨ 두 텍스트가 동일합니다!</b></p>"
                result_html += "<p>(줄바꿈과 공백 차이는 무시됨)</p>"
...
if __name__ == '__main__':
    try:
        ...
        print("=" * 60)
        print("PDF 텍스트 비교 도구 (강력한 정규화 적용)")
        print("=" * 60)
        print("정규화 기능:")
        print("- 모든 줄바꿈(\\n, \\r)을 공백으로 치환")
        print("- 연속된 공백을 단일 공백으로 통합")
        print("- 표의 셀 크기나 레이아웃 차이로 인한 줄바꿈 무시")
        print("=" * 60)
        print()
