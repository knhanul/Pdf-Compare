...
# ºôµå ½Ã ¿ÜºÎ(¹èÄ¡ ÆÄÀÏ)¿¡¼­ ÁÖÀÔ¹Þ´Â Á¤º¸, ¾øÀ» °æ¿ì ±âº»°ª »ç¿ë
...
# Àü¿ë »ö»ó Á¤ÀÇ
COLOR_P1 = QColor(255, 255, 0, 120)   # Çü±¤ ³ë¶õ»ö (PDF1)
COLOR_P2 = QColor(0, 255, 127, 130)  # Çü±¤ ¿¡¸Þ¶öµå»ö (PDF2)
COLOR_AREA = QColor(0, 120, 255, 15) # ÃÖ±Ù ºñ±³ ±¸¿ª
COLOR_MAIN_BLUE = "#004b93"
COLOR_COMPARE_BTN = "#FF6D00"        # Áß¾Ó ÁÖÈ²»ö
COLOR_INFO_BTN = "#FFEB3B"           # ³ë¶õ»ö Á¤º¸ ¹öÆ°

def get_resource_path(relative_path):
    """EXE ½ÇÇà ½Ã ³»ºÎ ¸®¼Ò½º °æ·Î¸¦ Ã£´Â ÇÔ¼ö (PyInstaller È£È¯)"""
    try:
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        icon_path = get_resource_path('posid_logo.ico')
        ...
        col1 = QLabel(
            "<b>?? ÁÖÀÇ</b><br>"
            "1. º» ÇÁ·Î±×·¥Àº <b style='color:red;'>ÇÑ±Û, ¿µ¹®, ¼ýÀÚ</b>¸¸À» Á¤±ÔÈ­ ´ëÁ¶ÇÕ´Ï´Ù.<br>"
            "2. ¸ðµç °ø¹éÀ» Á¦°ÅÇÏ°í ºÐ¼®ÇÏ¹Ç·Î <b style='color:red;'>¶ç¾î¾²±â ¿À·ù´Â °ËÁõµÇÁö ¾Ê½À´Ï´Ù.</b>"
        )
        col2 = QLabel(
            "<br>" 
            "3. Ç¥(Table) ÃßÃâ ½Ã ¼¿ ³»¿ëÀÌ ¼¯ÀÏ ¼ö ÀÖÀ¸¹Ç·Î ¹Ýµå½Ã <b style='color:red;'>¼¿ ´ÜÀ§ µå·¡±×</b>¸¦ ±ÇÀåÇÕ´Ï´Ù.<br>"
            "4. ±ä º¹ÇÕ¾î´Â ±¸Á¶ Â÷ÀÌ·Î <b style='color:red;'>ÇÑÂÊ¸¸ ÇÏÀÌ¶óÀÌÆ®</b>µÉ ¼ö ÀÖÀ¸´Ï ´ëÁ¶°¡ ÇÊ¿äÇÕ´Ï´Ù."
        )
    ...
    def show_info(self):
        ...
        img_path = get_resource_path('posid_logo.png')
        if os.path.exists(img_path):
            img = QLabel(); img.setPixmap(QPixmap(img_path).scaled(200, 80, Qt.AspectRatioMode.KeepAspectRatio)); img.setAlignment(Qt.AlignmentFlag.AlignCenter); l.addWidget(img)
